...
def run_initial_sync() -> None:
    ...
    print(f"Cargando y validando {len(raw_docs)} productos desde MongoDB Atlas...")
    ...
    print(f"Generando vectores mediante {provider_name}...")
    ...
    print(f"Sincronización exitosa: {len(ids)} vectores cargados en ChromaDB.")
